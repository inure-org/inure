    ...
    def create
        ...
        respond_to do |format|
            if @admin_project.save
                format.html { redirect_to [:admin, @admin_project], notice: 'projeto foi criado com sucesso.' }
    ...
    def update
        ...
        respond_to do |format|
            if @admin_project.update_attributes(params[:project])
                format.html { redirect_to [:admin, @admin_project], notice: 'projeto foi atualizado com sucesso.' }
                format.json { head :ok }
            else
